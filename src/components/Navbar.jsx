...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className=" flex overflow-clip border-2 p-2 gap-2 items-center justify-between "
        style={{
      ...
      >
        ...
        <div className="border-2 w-[50%] flex bg-blue-300 rounded-2xl h-8">
          <input type="text" onChange={null} className="w-full focus:outline-0 flex-1 px-2 text-sm" />
        ...
        >
          ...
          <IoIosArrowDropright className={`transition-transform duration-200 ${val === 'block' ? 'rotate-90' : ''}`} />
        </div>
        <div
        ...
        <NavLink id="seller" title="Seller-Account" className="hover:cursor-pointer ">
          <IoMenuSharp/>
